...
from .models import Problema, CodeImage
...
class ProblemaSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        author = request.user
        problema = Problema.objects.create(author=author, **validated_data)
        for image in images.getlist('images'):
            CodeImage.objects.create(image=image, problema=problema)
        return problema
